...
public class BitwiseOne {
  ...
  public static void main(String[] args) {
    System.out.println(bitwiseOne(new String[]{"001110", "100000"})); // 101110
    System.out.println(bitwiseOne(new String[]{"110001", "111100"})); // 111101
    System.out.println(bitwiseOne(new String[]{"1001", "0100"})); // 1101
    System.out.println(bitwiseOne(new String[]{"1111", "0000"})); // 1111
    System.out.println(bitwiseOne(new String[]{"1010", "0101"})); // 1111
    System.out.println(bitwiseOne(new String[]{"0000", "0000"})); // 0000
  }
